...
pr = Proposal(
    name='proposal7',
    url='https://helpforcancercentral.com/proposal7',
...
# TODO: make this a test, mock 'helpforcancerd' and tie a test block height to a
# timestamp, ensure only unit testing a within_window method
#
# also, create the `within_window` or similar method & use that.
#
bh = 131112
bh_epoch = helpforcancerd.block_height_to_epoch(bh)
...
# pdb.set_trace()
# helpforcancerd.get_object_list()
# ==============================================================================
# pdb.set_trace()
1
