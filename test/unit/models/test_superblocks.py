...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "TXDSaTXerg68SCyLkWw2ERsqoTMWRBZiZQ", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://helpforcancercentral.org/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "TDWz9KfMo55wzj2brbgaXxnDz28nAbdPcY", "payment_amount": 32.01, "start_epoch": 1474261086, "type": 1, "url": "http://helpforcancercentral.org/fernandez-7625"}]]',
...
def test_deterministic_superblock_creation(go_list_proposals):
    ...
    sb = helpforcancerlib.create_superblock(prop_list, 72000, max_budget, misc.now(), maxgovobjdatasize)
